...
const typingLine = 'Spécialisé dans les applications interactives en temps réel';
  ...
  return (
    <section className="section-shell pt-16 sm:pt-20" aria-labelledby="hero-title">
      <div className="glass-card relative overflow-hidden p-6 sm:p-10">
        ...
        >
          Gaëtan <span className="headline-gradient">- Développeur Full-Stack</span>
        </motion.h1>
        ...
        <div className="mt-6 grid gap-3 text-sm text-base-content/80 sm:grid-cols-2 sm:max-w-xl">
          ...
          <p>
            <span className="font-semibold text-base-content">Disponibilité :</span> Maintenant
          </p>
        </div>
